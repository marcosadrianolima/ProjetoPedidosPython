        ...
        {isAuthenticated && (
          <>
            ...
            {isSmallScreen ? (
              ...
              <Button color="inherit" startIcon={<PeopleIcon />} onClick={() => navigate('/funcionarios')}>
                Funcionários
              </Button>
            )}
            ...
            {isSmallScreen ? (
              ...
              <Button color="inherit" startIcon={<PersonIcon />} onClick={() => navigate('/clientes')}>
                Clientes
              </Button>
            )}
            ...
            {isSmallScreen ? (
              ...
              <Button color="inherit" startIcon={<ShoppingCartIcon />} onClick={() => navigate('/produtos')}>
                Produtos
              </Button>
            )}
